...
```{r horse-plot, echo=FALSE, out.width="80%", out.height="80%"}
...
```{r horse-sd, echo=FALSE, out.width="80%", out.height="80%"}
horses_sd_table <- read_csv("../../results/horses_sd.csv")
largest_sd <- horses_sd_table$Province[1]
knitr::kable(horses_sd_table, caption = "Standard Deviation of the Number of Horses")
```
...
```{r large-sd, echo=FALSE, out.width="80%", out.height="80%"}
knitr::include_graphics("../../results/horse_pop_plot_largest_sd.png")
```

```{r include = FALSE}
largest <- "Saskatchewan"
# largest <- "Ontario"
# largest <- "Alberta"
# largest <- "Manitoba"
# largest <- "Quebec"
# largest <- "New Brunswick"
# largest <- "Nova Scotia"
...
In Figure 2 we zoom in and look at the province of 'r largest', which had the largest spread of values in terms of standard deviation.
